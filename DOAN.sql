-- Active: 1779955421594@@mysqldbt-dbt1.l.aivencloud.com@13268@TransCo
-- Topic: TinyCollege
...
-- Active: 1779955421594@@mysqldbt-dbt1.l.aivencloud.com@13268@TinyCollege
-- Truyvan - Views
...
FROM EMPLOYEE e
JOIN BRANCH b ON e.BRANCH_CODE = b.BRANCH_CODE
LEFT JOIN warehouse_info wi ON e.EMP_CODE = wi.MANAGER_EMP_CODE
LEFT JOIN warehouse_orders wo ON e.EMP_CODE = wo.MANAGER_EMP_CODE
